...
<nav class="space-y-4">
    ...
    <div class="space-y-1">
        ...
        <div id="submenu-akademik" class="sidebar-submenu pl-4 space-y-1 mt-1">
            <a href="{{ route('admin.tahun-akademik.index') }}" class="{{ Route::is('admin.tahun-akademik.index') ? 'active-link' : '' }}">
                Tahun Akademik
            </a>
            <a href="{{ route('admin.prodi.index') }}" class="{{ Route::is('admin.prodi.index') ? 'active-link' : '' }}">
                Program Studi
            </a>
            <a href="{{ route('admin.classes.index') }}" class="{{ Route::is('admin.classes.index') ? 'active-link' : '' }}">
                Data Kelas
            </a>
            <a href="{{ route('admin.courses.index') }}" class="{{ Route::is('admin.courses.index') ? 'active-link' : '' }}">
                Mata Kuliah
            </a>
        </div>
    </div>
    ...
    <div class="space-y-1">
        ...
        <div id="submenu-cbtmu" class="sidebar-submenu pl-4 space-y-1 mt-1">
            <a href="{{ route('admin.bank-soal.index') }}" class="{{ Route::is('admin.bank-soal.index') ? 'active-link' : '' }}">
                Bank Soal
            </a>
            <a href="{{ route('admin.exams.index') }}" class="{{ Route::is('admin.exams.index') ? 'active-link' : '' }}">
                Jadwal Ujian
            </a>
            <a href="{{ route('admin.monitoring.index') }}" class="{{ Route::is('admin.monitoring.index') || Route::is('admin.monitoring.detail') ? 'active-link' : '' }}">
                Monitoring Ujian
            </a>
            <a href="{{ route('admin.analisis.index') }}" class="{{ Route::is('admin.analisis.index') ? 'active-link' : '' }}">
                Analisis Butir Soal
            </a>
            <a href="{{ route('admin.pengumuman.index') }}" class="{{ Route::is('admin.pengumuman.index') ? 'active-link' : '' }}">
                Pengumuman
            </a>
        </div>
    </div>
    ...
    <div class="space-y-1">
        ...
        <div id="submenu-feeder" class="sidebar-submenu pl-4 space-y-1 mt-1">
            <a href="{{ route('admin.users.index') }}" class="{{ Route::is('admin.users.index') ? 'active-link' : '' }}">
                Data Pengguna
            </a>
            <a href="{{ route('admin.feeder.index') }}" class="{{ Route::is('admin.feeder.index') ? 'active-link' : '' }}">
                Sinkronisasi Feeder
            </a>
        </div>
    </div>
    ...
    <div class="space-y-1">
        ...
        <div id="submenu-system" class="sidebar-submenu pl-4 space-y-1 mt-1">
            <a href="{{ route('admin.audit.index') }}" class="{{ Route::is('admin.audit.index') ? 'active-link' : '' }}">
                Audit System
            </a>
        </div>
    </div>
