...
<nav class="space-y-4">
    ...
    <div class="space-y-1">
        ...
        <div id="submenu-cbtmu" class="sidebar-submenu pl-4 space-y-1 mt-1">
            <a href="{{ route('dosen.questions.index') }}" class="{{ Route::is('dosen.questions.index') || Route::is('dosen.bank-soal.show') ? 'active-link' : '' }}">
                Bank Soal
            </a>
            <a href="{{ route('dosen.exams.index') }}" class="{{ Route::is('dosen.exams.index') ? 'active-link' : '' }}">
                Jadwal Ujian
            </a>
            <a href="{{ route('dosen.grades.index') }}" class="{{ Route::is('dosen.grades.index') ? 'active-link' : '' }}">
                Rekap & Cetak Nilai
            </a>
            <a href="{{ route('dosen.analisis.index') }}" class="{{ Route::is('dosen.analisis.index') ? 'active-link' : '' }}">
                Analisis Butir Soal
            </a>
        </div>
    </div>
