...
<div class="space-y-6">
    ...
    <div class="bg-white p-4 rounded-xl border border-gray-250 shadow-sm">
        <form method="GET" action="{{ route('dosen.analisis.index') }}" class="flex flex-col md:flex-row items-end gap-4">
            ...
            <div class="flex space-x-2 w-full md:w-auto">
                ...
                <a href="{{ route('dosen.analisis.export', $selectedExam->id) }}" class="bg-secondary bg-green-700 text-white font-bold py-2 px-4 rounded-lg text-xs uppercase tracking-wider transition shadow-sm text-center w-full md:w-auto cursor-pointer flex items-center justify-center space-x-1.5">
