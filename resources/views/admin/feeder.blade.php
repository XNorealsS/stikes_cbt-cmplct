...
<div class="space-y-5">
    ...
    <div class="border-b border-slate-200 pb-3">
        <h1 class="text-lg font-bold text-slate-800">Sinkronisasi Neo Feeder PDDIKTI</h1>
        <p class="text-xs text-slate-500 mt-0.5">
            Sinkronisasi data mahasiswa, dosen, prodi, semester, dan kelas kuliah langsung dari Neo Feeder PDDIKTI STIKes Muhammadiyah Lhokseumawe.
        </p>
    </div>
    ...
    <div>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-2">
            @foreach(['semester' => ['label' => 'Semester', 'icon' => 'fa-calendar'], 'prodi' => ['label' => 'Prodi', 'icon' => 'fa-building-columns'], 'mahasiswa' => ['label' => 'Mahasiswa', 'icon' => 'fa-user-graduate'], 'dosen' => ['label' => 'Dosen', 'icon' => 'fa-chalkboard-teacher'], 'kelas' => ['label' => 'Kelas', 'icon' => 'fa-door-open']] as $entity => $info)
            <button
    ...
    function doSync(entity) {
        ...
        .then(data => {
            ...
            if (isAll) {
                ...
                const entityBtn = document.querySelector(`.entity-sync-btn[data-entity="${entity}"]`);
                const labels = {semester:'Semester', prodi:'Prodi', mahasiswa:'Mahasiswa', dosen:'Dosen', kelas:'Kelas'};
                const icons  = {semester:'fa-calendar', prodi:'fa-building-columns', mahasiswa:'fa-user-graduate', dosen:'fa-chalkboard-teacher', kelas:'fa-door-open'};
                if (entityBtn) {
